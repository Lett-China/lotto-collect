...
class LottoKenoKoYf extends BasicModel
{
    use Lotto28Trait;

    public $rememberCacheTag = 'lotto_keno_ko_yf';

    protected $lotto_name = 'koyf28';

    protected $table = 'lotto_keno_ko_yf';
    ...
    public function lottoCreate()
    {
        ...
        if ($next_time < time()) {
            $time_a    = time();
            $time_b    = strtotime('2019-06-06') + 30;
