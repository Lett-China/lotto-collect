...
class LottoKenoUsa extends BasicModel
{
    use Lotto28Trait;

    public $rememberCacheTag = 'lotto_keno_usa';

    protected $lotto_name = 'usa28';

    protected $table = 'lotto_keno_usa';
    ...
    public function lottoCreate()
    {
        ...
        if ($next_time < time()) {
            $time_a    = time();
            $time_b    = strtotime('2020-10-01') + 60;
